...
const Product: React.FC<ProductProps> = ({ product }) => {
  return (
    <div className="w-full md:w-[22rem] lg:w-[16rem] gap-2 h-[20rem] group relative rounded-md bg-stone-300 dark:bg-stone-500 group">
      ...
      <div className="flex items-center justify-between px-1 h-8 my-2">
