    ...
    <div className="my-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-center justify-center">
        {products.slice(0, 4).map((product) => (
          <div
            key={product._id}
            className="w-full md:w-[22rem] lg:w-[16.5rem] h-[20rem] gap-2 relative rounded-md bg-stone-300 dark:bg-stone-500 group"
          >
            <span className="z-[5] absolute top-0 left-2 font-bold text-white">
              {product.name}
            </span>
            <Image
